	...
	initComponent: function(){
		...
		this.addressSearch = new Phlexible.googlemaps.util.AddressSearch({
			...
			listeners: {
				...
				select: function(addressSearch, resultData) {
...
//        this.wrap.setStyle('overflow', 'hidden');
	...
	validateValue: function(value) {
		...
		return Phlexible.googlemaps.field.AddressField.superclass.validateValue.call(this, value);
	},
	...
	onRender : function(ct, position){
		Phlexible.googlemaps.field.AddressField.superclass.onRender.call(this, ct, position);
...
Ext.reg('addressfield', Phlexible.googlemaps.field.AddressField);
